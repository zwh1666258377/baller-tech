...
const Index = () => {
  ...
  const submit = value => {
    ...
    const data = {
      ...
      audioTranslationRules: supportedLan,
    };
    ...
    return (
      <>
        ...
        <Form.Item label="可识别语种">
          <Form.Item
            name="audio-translation-lan-label"
            style={{ display: 'inline-block', marginRight: 8 }}
          >
            <Input placeholder="语种名称" />
          </Form.Item>
          <Form.Item
            name="audio-translation-lan-key"
            style={{ display: 'inline-block', marginRight: 8 }}
          >
          ...
          <Button
            ...
            onClick={() => {
              const label = form.getFieldValue('audio-translation-lan-label');
              const key = form.getFieldValue('audio-translation-lan-key');
